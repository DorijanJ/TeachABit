...
public interface IRadioniceRepository
{
    ...
    public  Task<List<RadionicaFavorit>> GetAllRadioniceFavoritForCurrentUser(string username);
    public  Task<List<Radionica>> GetAllRadioniceForCurrentUser(string username);
