      ...
      >
        ...
        >
          ...
          {isExpanded ? (
            ...
            <Box style={{ height: "150px", marginTop: "30px" }}></Box>
          )}
          <List
            sx={{
              width: "100%",
          ...
          >
            <NavigationItem
              ...
              icon={
                <BookIcon color="primary" className={localStyles.navImage} />
              }
            ...
            <NavigationItem
              ...
              icon={
                <GroupIcon color="primary" className={localStyles.navImage} />
              }
              isExpanded={isExpanded}
            />
            <NavigationItem
              ...
              icon={
                <ForumIcon color="primary" className={localStyles.navImage} />
              }
              isExpanded={isExpanded}
            />
          </List>
          ...
          {globalContext.userIsLoggedIn === true &&
            ...
            isExpanded && <NavigationUser user={globalContext.loggedInUser} />}
